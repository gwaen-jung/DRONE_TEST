...
// Vi tri that da kiem tra tren drone (nhin tu tren xuong, dau drone o phia tren):
// GPIO13 = truoc-trai, GPIO27 = truoc-phai, GPIO14 = sau-phai, GPIO12 = sau-trai.
// M1 -> GPIO13 (front-left), M2 -> GPIO27 (front-right),
// M3 -> GPIO14 (rear-right), M4 -> GPIO12 (rear-left).
static const gpio_num_t kMotorPins[4] = {
  GPIO_NUM_13, GPIO_NUM_27, GPIO_NUM_14, GPIO_NUM_12
};
